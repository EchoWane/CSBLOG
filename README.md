...
Want to write a guest post or contribute? Pull requests welcome!

### How to Contribute

1. Fork the repo
2. Add your info in `src/data/authors.ts`
3. Create your post in `src/content/blog/your-post-title.md`
