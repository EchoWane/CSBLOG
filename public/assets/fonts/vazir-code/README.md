...
@font-face {
  ...
  src:
    url("Vazir-Code.eot?#iefix") format("embedded-opentype"),
...
@font-face {
  ...
  src:
    url("Vazir-Code-Hack.eot?#iefix") format("embedded-opentype"),
...
```html
<link
  href="https://cdn.rawgit.com/rastikerdar/vazir-code-font/v[X.Y.Z]/dist/font-face.css"
  rel="stylesheet"
  type="text/css"
/>
```
